...
def plot_opinions(folder_name, topic, daily_factor, concern_threshold,
    ...
    with open(f'{folder_name}/calibration_info.json') as json_file:
        ...
        parameters['collector_mode'] = 'opinions'
        ...
        results.plot_concern(measure_time=measure_time, history=history,
                             title=title,
        ...
        results.plot_opinions(sim_config=sim_config, measure_time=measure_time,
                              title=title,
                              filename=f'{folder_name}/best_solution_'
                                       f'opinions.png')
