...
from abm4problemod.calibration.algorithm.pso import PSO
...
def main():
    ...
    parser.add_argument("-c", "--cognitive_weight", type=float,
                        help="Cognitive weight for PSO", default=1.49618)
    parser.add_argument("-w", "--social_weight", type=float,
                        help="Social weight for PSO", default=1.49618)
    parser.add_argument("-i", "--inertia_weight", type=float,
                        help="Inertia weight for PSO", default=0.7298)
    ...
    output_dir = f'results/PSO-{args.cognitive_weight}-{args.social_weight}-{args.inertia_weight}_calibration'
    ...
    # Create DE Optimizer #####################################################
    optimizer = PSO(problem=problem, swarm_size=args.pop_size,
                    max_evaluations=args.max_evaluations,
                    swarm_generator=RandomGenerator(),
                    swarm_evaluator=SequentialEvaluator(),
                    objective_idx=2,
                    max_diff=0.9,
                    min_diff=0.1,
