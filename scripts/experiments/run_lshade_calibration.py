...
from abm4problemod.calibration.algorithm.lshade import LSHADE
...
def main():
    ...
    parser.add_argument("-f", "--memory_size", type=check_positive,
                        help="Size of the control parameter memory", default=6)
    parser.add_argument("-a", "--archive", action='store_true',
                        help="Use solution archive or not")
    parser.add_argument("-r", "--reduce", action='store_true',
                        help="Use linear reduction of population size or not")
    ...
    output_dir = f'results/LSHADE-{args.memory_size}-{args.archive}-{args.reduce}_calibration'
    ...
    history = load_history(f'data/{args.topic}/{topic}_history.csv')
    ...
    # Create DE Optimizer #####################################################
    optimizer = LSHADE(problem=problem, population_size=args.pop_size,
                       ...
                       H=args.memory_size, reduce_population=args.reduce,
